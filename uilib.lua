...
local utility = {}
--
local check_exploit = (syn and "Synapse V1.17.0") or (KRNL_LOADED and "Krnl") or (isourclosure and "ScriptWare") or nil
...
function library:new(props)
	-- // properties
	local textsize = props.textsize or props.TextSize or props.textSize or props.Textsize or 16
